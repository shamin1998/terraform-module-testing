...
# output testing_out {
#     value = module.requests_layer.testing_out
# }
...
module lambda_function {
    ...
    layers = [module.requests_layer.layer_arn]
    environment = var.environment
    
}

# output testing_out {
#     value = var.trigger.vars.arn
# }
...
module s3_notification {
    ...
    bucket_name = var.environment.variables.S3_TRANSFORMER_TO_DESTINATION_BUCKET
